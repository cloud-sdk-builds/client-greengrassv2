...
[`@aws-sdk/client-greengrassv2`](https://www.npmjs.com/package/@aws-sdk/client-greengrassv2/v/3.606.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-greengrassv2@3.606.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h2IPqsWbVAlWULSALcHWLC9We4CVMbVcMR8MGA5mvuCdq6epbum+7hGrkA4QKncX
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-greengrassv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-greengrassv2@3.606.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-greengrassv2@3.606.0/index.min.mjs": "sha384-h2IPqsWbVAlWULSALcHWLC9We4CVMbVcMR8MGA5mvuCdq6epbum+7hGrkA4QKncX"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-greengrassv2/blob/refs/tags/3.606.0/LICENSE
```
