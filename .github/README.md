...
[`@aws-sdk/client-greengrassv2`](https://www.npmjs.com/package/@aws-sdk/client-greengrassv2/v/3.79.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-greengrassv2@3.79.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V7n7i1bqhav0BVQbbnLi86kVixyLSHwcpF/QmbGjNCQzCbDodT+di0XGnErADDVu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-greengrassv2": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-greengrassv2@3.79.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-greengrassv2@3.79.0/index.min.mjs": "sha384-V7n7i1bqhav0BVQbbnLi86kVixyLSHwcpF/QmbGjNCQzCbDodT+di0XGnErADDVu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-greengrassv2/blob/refs/tags/3.79.0/LICENSE
```
